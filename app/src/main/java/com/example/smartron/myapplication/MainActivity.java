...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Calling a service/intent service in a loop
        for (int s = 0; s < 100; s++) {
        ...
        //newUserSignUp();
        findViewById(R.id.doSignIn).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                doLogin("srinivas.rupani@gmail.com", "9999999999");
            }
        });
    ...
    private void doLogin(String email, String password) {
        ...
        PhoneAuthProvider.getInstance().verifyPhoneNumber(
                "+919949272772",        // Phone number to verify
                60,                 // Timeout duration
